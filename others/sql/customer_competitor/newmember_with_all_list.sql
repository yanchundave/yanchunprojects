-- this table contains all users disbursement and all users with nonchime disbursement
-- It doesn't contains all users without disbursement
CREATE OR REPLACE TABLE DBT.DEV_YANCHUN_PUBLIC.competitors_newmember_list AS
...
(
    SELECT
        ...
        a.date_of_ref,
        a.newmember_type,
        'dave_disburse' as competitor_name,
        disbursement.disbursement_ds_pst as transaction_date,
        disbursement.taken_amount as amount
