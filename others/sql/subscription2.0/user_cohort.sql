CREATE OR REPLACE TABLE DBT.DEV_YANCHUN_PUBLIC.sub_migration_user_cohort AS
-- Jira ticket DAT 2198
with monthly_sub AS (
...
(
    ...
    WHERE EVENT_TYPE = '[Experiment] Assignment'
        ...
        and TO_NUMBER(user_id)  is not null AND user_id <> 'NaN'
        GROUP BY 1
)
...
LEFT JOIN paywall
    on jun_subs.USER_ID = paywall.USER_ID
WHERE kyc_decision.NAME = 'accept'
    and paywall.USER_ID is NULL