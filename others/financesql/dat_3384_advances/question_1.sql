...
advance_category AS (
    SELECT
        ...
        PAYBACK_DATE,
        DATEDIFF('DAY', DISBURSEMENT_DS, ORIGINAL_PAYBACK_DATE) AS DATESDIFF,
        CASE
            WHEN DATESDIFF < 15 THEN 'LESS THEN 15 DAYS'
            WHEN DATESDIFF BETWEEN 15 AND 30 THEN 'BETWEEN 15 AND 30 DAYS'
            ELSE 'GREATER THAN 30 DAYS'
