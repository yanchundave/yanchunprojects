...
def ltv_stats_model(df):
    try:
        ...
        dfupdate[
            "PRED_NUM"
        ] = bgfupdate.conditional_expected_number_of_purchases_up_to_time(
        ...
        dfupdate["EXPECTED_MONETARY"] = ggf.conditional_expected_average_profit(
            dfupdate["FREQUENCY"], dfupdate["MONETARY_UPDATE"]
        )
        ...
        return dftotal.loc[
            :, ["USER_ID", "T_VALUE", "PRED_NUM", "EXPECTED_MONETARY", "PREDICT_CLV"]
        ]
    except Exception as e:
        log.error("Could not get the training result")
