...
#revenue
dt_2 = read.csv("/Users/yanchunyang/Documents/datafiles/pystan/revenue/mmm_r_raw_one.csv")
##dt_2 = read.csv("/Users/yanchunyang/Documents/datafiles/mmm_robyn/robyn_data.csv")
tail(dt_2)
